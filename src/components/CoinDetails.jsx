import { Badge, Box, Container, HStack, Image, Progress, Radio, RadioGroup, Stat, StatArrow, StatHelpText, StatLabel, StatNumber, VStack, Text, Button } from '@chakra-ui/react'
...
const CoinDetails = () => {
    ...
    if (error) return <ErrorComponent message={'Erorr while fetching Coin'} />
